"""
My Python final project For A Library Book Tracker_KabPython Series

By: TURYAKIRA CRESENT.

Description of the project("Library Book Tracker"):

The Library Book Tracker simulates a library system where users can add books,
check out books,  and return them or Display All The Available Books In The Library.
You can even exit the program using option 5.
"""
class Book:
...
if __name__ == "__main__":
    """
            checks if the script is being
            run directly(not imported as a module in another script)
    """
